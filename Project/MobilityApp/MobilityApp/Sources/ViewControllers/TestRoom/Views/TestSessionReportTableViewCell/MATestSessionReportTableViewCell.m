//
//  MATestSessionReportTableViewCell.m
//  MobilityApp
//
...
NSString * const kMATestSessionReportTableViewCellIdentifier = @"MATestSessionReportCell";

@implementation MATestSessionReportTableViewCell
